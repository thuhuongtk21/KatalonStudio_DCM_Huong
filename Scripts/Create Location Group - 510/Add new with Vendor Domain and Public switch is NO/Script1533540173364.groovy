...
WebUI.click(findTestObject('Page_Create Location Group - Cost a/span_caret'))

WebUI.click(findTestObject('Page_Create Location Group - Cost a/span_VEND - BOTH HEB AND VENDO'))

WebUI.selectOptionByValue(findTestObject('Page_Create Location Group - Cost a/select_- Select -HEB - HEB ONL'), 'VEND - BOTH HEB AND VENDORS', 
    true)
