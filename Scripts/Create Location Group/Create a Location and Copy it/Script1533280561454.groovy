...
WebUI.click(findTestObject('Page_Create Location Group - Cost a/button_delete'))

WebUI.click(findTestObject('Page_Create Location Group - Cost a/confirm_button_Yes'))

WebUI.verifyElementPresent(findTestObject('Deal Maintenance Page/delete_success_message'), 60)
